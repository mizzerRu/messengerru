...
import com.rumessanger.msg.databinding.ActivityChatBinding;
import com.rumessanger.msg.message.Message;
import com.rumessanger.msg.message.MessageAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.sendMessageBtn.setOnClickListener(v -> {
            ...
            binding.messageEt.setText(""); // clear the edit text
        ...
        FirebaseDatabase.getInstance().getReference().child("Chats")
                .child(chatId).child("messages").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        binding.messagesRv.scrollToPosition(lastItemPosition);
